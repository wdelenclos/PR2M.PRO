                            ...
                            <div class="x_content">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <ul class="nav nav-tabs tabs-left">
                                        <li class="active"><a href="#evip" data-toggle="tab">EVIP</a>
                                        </li>
                                        ...
                                        <li><a href="#emme" data-toggle="tab">EMME</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="evip">
                                            ...
                                            <ul>
                                                ...
                                                <li>Suivre la liste des items dans l&rsquo;ordre propos&eacute; (cf document &laquo; protocole_EVIPb.pdf &raquo;)
                                                    <ul>
                                                        ...
                                                        <li><strong>Pour les enfants de 8 ans :</strong> le point de d&eacute;part est <strong>l&rsquo;item 20</strong> (illumination)</li>
                                                    </ul>
                                                </li>
                                                <li>Ne donner AUCUN indice</li>
                                                <li>Ne donner AUCUN feedback</li>
                                                ...
                                                <li>Chronom&eacute;trer la dur&eacute;e de passation</li>
                                            </ul>
                                            ...
                                            <ul>
                                                <li><strong>+ ou -&nbsp;: </strong>
                                                    <ul>
                                                        <li>+ si l&rsquo;item est correctement d&eacute;sign&eacute;</li>
                                                ...
                                                <li>Cette cotation doit se faire &agrave; la main (cf document &laquo;&nbsp;protocole_EVIPb.pdf&nbsp;&raquo;)
                                                    <ul>
                                                        ...
                                                        <li>SCORE BRUT&nbsp;: num&eacute;ro de l&rsquo;item plafond <em>moins</em> les &eacute;checs</li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="tab-pane" id="lexical">
                                            ...
                                            <p><strong>I. Le logiciel &ndash; mode d&rsquo;emploi</strong></p>
                                            <ul>
                                            ...
                                            <p>&nbsp;</p>
                                            <p>II.&nbsp;<strong>L&rsquo;&eacute;preuve &ndash; mode d&rsquo;emploi</strong></p>
                                            <ul>
                                        ...
                                        <div class="tab-pane" id="vtnv">
                                            ...
                                            <p><strong><span style="text-decoration: underline;">Consignes pour l&rsquo;exp&eacute;rimentateur&nbsp;:</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></p>
                                            <ul>
                                                <li>Ouvrir l&rsquo;application</li>
                                                <li>Remplir les champs demand&eacute;s&nbsp;:
                                                    <ul>
                                                        <li>Nom</li>
                                                        <li>Pr&eacute;nom</li>
                                                        <li>Nombre de r&eacute;p&eacute;tition&nbsp;: <strong>40 </strong></li>
                                            ...
                                            <p>&nbsp;</p>
                                            <p><span style="text-decoration: underline;"><strong>Consignes pour l&rsquo;enfant (avant d&rsquo;appuyer sur &laquo;&nbsp;Valider&nbsp;&raquo;)&nbsp;:</strong></span></p>
                                            ...
                                            <ul>
                                                <li>Un fichier avec l&rsquo;ensemble des donn&eacute;es est g&eacute;n&eacute;r&eacute; automatiquement</li>
                                            </ul>
                                            <p><strong>&nbsp;</strong></p>
                                            <h5><strong>&nbsp;2)&nbsp;</strong><strong>Modalit&eacute; &laquo;&nbsp;Symbole non s&eacute;mantisable&nbsp;&raquo;</strong></h5>
                                            <p><span style="text-decoration: underline;"><strong>Consignes pour l&rsquo;exp&eacute;rimentateur&nbsp;: </strong></span></p>
                                            <ul>
                                                <li>M&ecirc;me protocole mais pour l&rsquo;onglet IMAGE s&eacute;lectionner <strong>Symbole non s&eacute;mantisable</strong></li>
                                            </ul>
                                            <p><strong>&nbsp;</strong></p>
                                            <p><span style="text-decoration: underline;"><strong>Consignes pour l&rsquo;enfant (avant d&rsquo;appuyer sur &laquo;&nbsp;Valider&nbsp;&raquo;)&nbsp;:</strong></span></p>
                                            <ul>
                                            ...
                                            <ul>
                                                <li>T&eacute;l&eacute;charger les fichiers g&eacute;n&eacute;r&eacute;s dans la plateforme</li>
                                            </ul>
                                        </div>
